...
import net.azisaba.lifenewpve.utils.LifeTime;
...
public class SavePointCommand implements TabExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        } else if (subCommand.equalsIgnoreCase("net/azisaba/api/utils/tasks")) {
    ...
    private static final List<String> COMMAND_SUGGESTIONS = List.of("search", "add", "remove", "tp", "reload", "task", "net/azisaba/api/utils/tasks", "addTag", "removeTag", "listTag");
